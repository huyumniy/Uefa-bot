...
print(extract_domain('https://womenseuro-resale.tickets.uefa.com/secured/selection/event/date?productId=10229214363736'))

print(extract_domain('https://www.uefa.com/womenseuro/ticketing/'))

print(extract_domain('https://www.uefa.com/'))

print(extract_domain('https://docs.google.com/spreadsheets/d/1Fdwp2SOZkdHokgGVnGmfHDy4fg4T1IU_YAph5yXysSg/edit?gid=0#gid=0'))

print(extract_domain('https://nationsleague.tickets.uefa.com/cart/reservation/0'))
